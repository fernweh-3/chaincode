...
type SmartContract struct {
	...
	lastAssetID string // this field only exists in memory and is not persisted
}
...
func (s *SmartContract) CreateAsset(ctx contractapi.TransactionContextInterface, id string, color string, size int, owner string, appraisedValue int) error {
	...
	// update the lastAssetID field in memory
	s.lastAssetID = id
	fmt.Println("lastAssetID updated to:", s.lastAssetID)
